...
public class BoolShapeShapeProc extends ShapeRule{
    ...
    public BoolShapeShapeProc(NewCompositionShape leftShape, NewCompositionShape rightShape, UUID id, String name, boolean matched, String boolXML, String boolCode, Function<String, Double> proceedWhenDeletingFromThumbnail, Function<String, Double> proceedToRedrawWhenDeleting, String processXML, String processCode) {
