...
public class ShapeShapeProc extends ShapeRule{
    ...
    public ShapeShapeProc(ParametricCompositionShape leftShape, ParametricCompositionShape rightShape, UUID id, String name, boolean matched, String processXML, String processCode, Function<String, Double> proceedWhenDeletingFromThumbnail, Function<String, Double> proceedToRedrawWhenDeleting) {
